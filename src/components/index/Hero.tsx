...
const Hero: React.FC = () => {
	return (
		<section className="grid grid-rows-2 grid-cols-1 h-screenMinusPlayer">
			...
			/>
			<h1 className="row-start-1 row-end-3 col-start-1 z-20 w-min pr-4 pb-12 justify-self-center self-center text-white font-display tracking-display text-hero indent-hero one-word-per-line text-shadow-xl">
				Tory Stories
			</h1>
